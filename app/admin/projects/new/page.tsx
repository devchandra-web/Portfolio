...
import { Save, CheckCircle2, AlertCircle, Loader2, ArrowLeft, FolderPlus } from "lucide-react";
...
export default function NewProjectPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    problem: "",
    solution: "",
    features: "Faceted filtering, Instant search, Checkout",
    challenges: "Cart state synchronization with inventory API",
    result: "Delivered 3x faster loading speed and increased mobile conversion.",
    mainImage: "/images/project-saas.svg",
    galleryImages: "[]",
    liveDemoUrl: "https://demo.example.com",
    githubUrl: "https://github.com/example/repo",
    caseStudy: "Full case study writeup details...",
    featured: false,
    published: true,
    displayOrder: 1,
  ...
  const [techInput, setTechInput] = useState("Next.js, TypeScript, Tailwind CSS");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (res.success) {
      ...
      setMessage({ type: "error", text: res.error || "Failed to create project" });
    }
  ...
  return (
    <div>
      <AdminHeader
        ...
        subtitle="Create a new project case study with technologies, problem/solution overview, and live URLs."
        action={
          <Button
            variant="outline"
            size="sm"
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <GlassCard className="p-6 sm:p-8 space-y-5">
          <div className="flex items-center space-x-2 pb-4 border-b border-slate-800">
            ...
            <h2 className="text-lg font-bold text-slate-100">Project Information</h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <input
                ...
                placeholder="e.g. Modern E-Commerce Storefront"
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. modern-ecommerce-storefront"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="Headless WooCommerce Storefront with Instant Checkout"
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              placeholder="High-performance e-commerce storefront powered by Next.js..."
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-300 mb-2">
              Full Overview Description <span className="text-emerald-400">*</span>
            </label>
            <textarea
              required
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-2">
                Solution Implemented <span className="text-emerald-400">*</span>
              </label>
              <textarea
                required
                name="solution"
          ...
          <div>
            ...
            <input
              ...
              placeholder="Next.js, React, TypeScript, Tailwind CSS, Stripe"
              className="w-full px-4 py-2.5 rounded-lg bg-slate-950/80 border border-slate-800 text-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-2">
                Main Image Preview URL <span className="text-emerald-400">*</span>
              </label>
              <input
                type="text"
                required
                ...
                onChange={handleChange}
                placeholder="/images/project-saas.svg"
                className="w-full px-4 py-2.5 rounded-lg bg-slate-950/80 border border-slate-800 text-slate-100 text-sm font-mono focus:outline-none focus:ring-2 focus:ring-emerald-500"
              />
            </div>
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-2">
                Result &amp; Impact Statement <span className="text-emerald-400">*</span>
              </label>
              <input
                type="text"
                required
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              <label className="block text-xs font-semibold text-slate-300 mb-2">
                Live Demo URL <span className="text-emerald-400">*</span>
              </label>
              <input
                type="text"
                required
          ...
          <div>
            <label className="block text-xs font-semibold text-slate-300 mb-2">
              Full Case Study Content <span className="text-emerald-400">*</span>
            </label>
            <textarea
              required
              name="caseStudy"
              ...
              onChange={handleChange}
              placeholder="Full case study breakdown details..."
              className="w-full px-4 py-2.5 rounded-lg bg-slate-950/80 border border-slate-800 text-slate-100 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 resize-none"
            />
          </div>
        ...
        <div className="flex justify-end space-x-3">
          ...
          >
            {saving ? "Creating Project..." : "Save Project"}
          </Button>
        </div>
      </form>
    </div>
